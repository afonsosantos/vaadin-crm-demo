...
public class ContactFormTest {
    ...
    public void setupData() {
        ...
        marchUsher = new Contact();
        marchUsher.setFirstName("Marc");
        marchUsher.setLastName("Usher");
        marchUsher.setEmail("march@usher.com");
        marchUsher.setStatus(Contact.Status.NotContacted);
        marchUsher.setCompany(company2);
    }

    @Test
    public void formFieldPopulated() {
        ContactForm form = new ContactForm(companies);
        form.setContact(marchUsher);

        Assert.assertEquals("Marc", form.firstName.getValue());
        Assert.assertEquals("Usher", form.lastName.getValue());
        Assert.assertEquals("march@usher.com", form.email.getValue());
